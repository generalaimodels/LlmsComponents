...
class AdvancedRAGApp:
    ...
    def run(self) -> None:
        ...
        while True:
            ...
            spoken_query = self.transcribe_microphone(30)
    ...
    def run_interactive(self) -> None:
        ...
        while True:
            if input_mode == "text":
                ...
                print("Speak your query (30 seconds):")
                query = self.transcribe_microphone(30)
            ...
            search_results = self.perform_similarity_search(query)
            context = " ".join([doc.page_content for doc in search_results])
            file=[doc.metadata["file_path"] for doc in search_results]
            print(file)
            response = self.generate_response(context, query)
