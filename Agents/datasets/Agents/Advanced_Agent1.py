...
class Advanced_Updated_Agent:
    def __init__(self,
                 knowledge_base_path: str,
                 max_workers: int = 4,
                 embedding_model: str=None,
                 reader_model_name: str=None,
        ...
        try:
            ...
            self.docs_processed = self.split_documents(1024, self.raw_knowledge_base)
            ...
            self.reader_llm = self.create_reader_llm(reader_model_name=reader_model_name,cache_dir=cache_dir,temperature=temperature,repetition_penalty=repetition_penalty,max_new_tokens=max_new_tokens)
            self.tokenizer = self.embedding_model
    ...
    def generate_answer(
       ...
       context =prepare_context(retrieved_docs, max_context_length, tokenizer)
