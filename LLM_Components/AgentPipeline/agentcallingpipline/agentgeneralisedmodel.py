...
class AgentPreProcessorPipeline:
    """
    ...
    def __init__(self, model_type: str, pretrained_model_name_or_path: str,*model_args, **kwargs):
        ...
        self.from_pertrained_processing=model_args
        logging.info(
    ...
    def tokenizer(self) -> AutoTokenizer:
        ...
        if self._tokenizer is None:
            ...
            self._tokenizer = AutoTokenizer.from_pretrained(
                self.pretrained_model_name_or_path,*self.from_pertrained_processing, **self.from_pretrained_kwargs
            )
