...
class AdvancedAgent:
    ...
    def create_reader_llm(reader_model_name: str, cache_dir: Optional[str] = None,
        ...
        try:
            bnb_config = BitsAndBytesConfig(
                ...
                bnb_4bit_compute_dtypebnb_4bit_compute_dtype=torch.bfloat16,
            )
    ...
    def interface_terminal(self) -> None:
        ...
        print("Thank you for using the Advanced Agent Terminal Interface!")

    def history_session(self) -> List[Dict[str, Any]]:
        """Return the current session history."""
        return self.history

# def main():
#     # Replace with your actual dataset path
#     knowledge_base_path = "path/to/your/dataset"
    
#     agent = AdvancedAgent(knowledge_base_path)
    
#     # Example usage
#     print(agent.single_prompt_function("Tell me a joke about AI"))
#     print(agent.batch_size_function(["What's the weather?", "Tell me about AI", "How are you?"]))
    
#     # Run the interactive terminal
#     agent.interface_terminal()
